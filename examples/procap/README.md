...
This folder contains self-contained training, evaluation, and benchmarking code for CAPY and ProCapNet on processed PRO-cap data.

The shell scripts in this directory are mainly internal wrappers for local runs and cluster submissions; use them as references if you need concrete argument examples.

## Overview

The PRO-cap workflow has four main steps:

1. Generate or obtain processed PRO-cap inputs using the upstream ProCapNet data workflow.
...
For benchmark tables, figures, and interpretation, see `RESULTS.md`. This
README focuses on the PRO-cap setup, training entrypoints, evaluation
entrypoint, and benchmark notebook implementation.
